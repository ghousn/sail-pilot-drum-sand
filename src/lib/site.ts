export const SITE = {
  ...
  description:
    "Custom uniforms for hotels, hospitals, factories, and enterprises across Pakistan. Scrubs, workwear, hospitality, and branded apparel — not school or college uniforms.",
  founded: 2020,
  city: "Karachi",
...
export const INDUSTRIES = [
  ...
  },
  {
    ...
    summary:
      "Medical apparel built for long rounds, frequent washes, and clear department identity — without looking like catalogue leftovers.",
  ...
  },
  {
    ...
    summary:
      "Branded workwear for the people who represent you: reception, security, drivers, facilities, and client-facing teams.",
  ...
  },
  {
    ...
    summary:
      "Coveralls, labour uniforms, high-visibility pieces, and supervisor kits — cut for Pakistani production floors.",
...
export const INDUSTRY_OPTIONS = [
  ...
  { value: "enterprises", label: "Enterprises & offices" },
  { value: "factories", label: "Factories & industry" },
  { value: "other", label: "Other workplace (describe below)" },
] as const;
